...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // 为阶段的下拉框，绑定选中下拉框的事件，根据选中的阶段填写可能行
...
<div style="position:  relative; left: 30px;">
    ...
    <div style="position: relative; top: -40px; left: 70%;">
        ...
        <button type="button" class="btn btn-default" id="cancelBtn" onclick="window.location.href='workbench/transaction/index.jsp'">取消</button>
    </div>
...
<form action="workbench/transaction/save.do" id="tranForm" method="post" class="form-horizontal" role="form"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-activitySrc" value="码农搬砖1">
            <input type="hidden" name="activityId" value="74a960f9239846b8b31373015aa42217"/>
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="create-contactsName" class="col-sm-2 control-label">联系人名称&nbsp;&nbsp;<a href="javascript:void(0);"
                ...
                class="glyphicon glyphicon-search"></span></a></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-contactsName" value="王力欧">
            <input type="hidden" name="contactsId" value="96b1d539d4a440849776d9acc107c83b"/>
        </div>
    </div>
